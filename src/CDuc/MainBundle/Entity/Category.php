...
class Category
{
     ...
     *
     * @ORM\ManyToMany(targetEntity="CDuc\MainBundle\Entity\Category", inversedBy="parentCategory")
     ...
     * Add childCategory
     *
     * @param \CDuc\MainBundle\Entity\Category $childCategory
     * @return Category
     */
    public function addChildCategory(\CDuc\MainBundle\Entity\Category $childCategory)
    {
     ...
     * @param \CDuc\MainBundle\Entity\Category $childCategory
     */
    public function removeChildCategory(\CDuc\MainBundle\Entity\Category $childCategory)
    {
