...
use CDuc\CampagneBundle\Form\JoueurType;
...
class JoueurController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CDucCampagneBundle:Joueur')->findAll();
     ...
     * @Method("POST")
     * @Template("CDucCampagneBundle:Joueur:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CDucCampagneBundle:Joueur')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("CDucCampagneBundle:Joueur:edit.html.twig")
     */
