...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'D:/Projets/perso/rp-tools/app/cache/prod/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('D:/Projets/perso/rp-tools/app/cache/prod/assetic/config'), false)));
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'jdr_online-tools', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_4f816fa1b38ccd3b27c7d38becd518dcb472f8364d87a36c5859d39ed64b95ad');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_4f816fa1b38ccd3b27c7d38becd518dcb472f8364d87a36c5859d39ed64b95ad');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_4f816fa1b38ccd3b27c7d38becd518dcb472f8364d87a36c5859d39ed64b95ad');
        $d = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array('D:\\Projets\\perso\\rp-tools\\src\\CDuc\\MainBundle\\Resources\\config\\doctrine' => 'CDuc\\MainBundle\\Entity'));
        ...
        $f->setEntityNamespaces(array('CDucMainBundle' => 'CDuc\\MainBundle\\Entity', 'CDucPageBundle' => 'CDuc\\PageBundle\\Entity'));
        $f->setMetadataCacheImpl($a);
        $f->setQueryCacheImpl($b);
        $f->setResultCacheImpl($c);
        $f->setMetadataDriverImpl($e);
        $f->setProxyDir('D:/Projets/perso/rp-tools/app/cache/prod/doctrine/orm/Proxies');
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('D:/Projets/perso/rp-tools/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('D:/Projets/perso/rp-tools/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('D:/Projets/perso/rp-tools/app/cache/prod/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => 'D:\\Projets\\perso\\rp-tools\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml'));
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'D:/Projets/perso/rp-tools/app/../web', false);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'D:/Projets/perso/rp-tools/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'D:/Projets/perso/rp-tools/app/cache/prod',
            ...
            'session.save_path' => 'D:/Projets/perso/rp-tools/app/cache/prod/sessions',
            ...
            'router.resource' => 'D:/Projets/perso/rp-tools/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'D:/Projets/perso/rp-tools/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => 'D:/Projets/perso/rp-tools/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'D:/Projets/perso/rp-tools/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => 'D:/Projets/perso/rp-tools/app/cache/prod/doctrine/orm/Proxies',
